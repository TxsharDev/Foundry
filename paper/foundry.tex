...
Foundry answers yes. It is a Rust compiler (4,247 lines across 10 modules) that reads an HTML file, resolves CSS at load time, computes flexbox layout, and renders via Vulkan/Metal/DX12. The \texttt{foundry build} command produces a self-contained native binary under 8\,MB with zero runtime dependencies.
...
\item \textbf{js.rs} (250 lines): JavaScript engine. boa integration, DOM bridge (\texttt{getElementById}, mutations), \texttt{console.log}.
...
\item 4,247 lines of Rust, 27 tests, 10 modules
\end{itemize}
